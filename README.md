...
![Trained Agent](https://github.com/blackrosedragon2/ReacherEnvironmentDL/blob/master/media/reacherp_ddpg_agent_small.gif?raw=true)
...
### Version 2: Twenty (20) Agents (Used in this project)
...
## Instructions
Then run the [`DDPG_Continuous_Control.ipynb`](https://github.com/blackrosedragon2/ReacherEnvironmentDL/DDPG_Continuous_Control.ipynb) notebook using the drlnd kernel to train the DDPG agent.
